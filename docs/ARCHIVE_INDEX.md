...
| [`archive/NEXT_UPDATE_V2_ADOPTIONS.md`](archive/NEXT_UPDATE_V2_ADOPTIONS.md) | superseded 2026-06-20 | [`NEXT_BUILD_BRIEF.md`](briefs/NEXT_BUILD_BRIEF.md) §F |
...
| [`archive/MAC_BATCH_RUNBOOK.md`](archive/MAC_BATCH_RUNBOOK.md) | superseded — verified against old revs (Flutter `2f41d95` / engine `90dd3a4`) | [`MAC_BRIEF_BETA_BATCH.md`](mac/MAC_BRIEF_BETA_BATCH.md) (current Mac residue) |
