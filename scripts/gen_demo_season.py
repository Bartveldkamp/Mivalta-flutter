...
# (resting_hr bpm, hrv_sdnn ms, spo2 fraction, sleep hours). Hand-authored to a
...
PHASES: list[tuple[str, list[tuple[float, float, float, float]]]] = [
    ("base", [
    ...
    ("recovery", [
        ...
        (55, 56, 0.98, 7.8), (54, 59, 0.98, 7.9), (53, 62, 0.98, 8.0),
...
def build() -> dict:
    ...
    for i, (rhr, hrv, spo2, sleep) in enumerate(rows):
        ...
        days.append({
            ...
            "hrv_sdnn": {"value": float(hrv), "unit": "ms"},
            "oxygen_saturation": {"value": float(spo2), "unit": "%"},
